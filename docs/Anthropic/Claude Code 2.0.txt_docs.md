# Documentation: Claude Code 2.0.txt

## File Metadata

- **Path**: `Anthropic/Claude Code 2.0.txt`
- **Size**: 57324 bytes (55.98 KB)
...
This file contains 1151 lines of text content.
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: secret, token, credential
...
- [`Sonnet 4.5 Prompt.txt`](./Sonnet 4.5 Prompt.txt_docs.md)
