# Documentation: Sonnet 4.5 Prompt.txt

## File Metadata

- **Path**: `Anthropic/Sonnet 4.5 Prompt.txt`
- **Size**: 43200 bytes (42.19 KB)
- **MIME Type**: text/plain
- **Lines**: 383
- **Words**: 6361
- **Last Modified**: 2025-11-15T09:41:05.374333
...
This file contains 383 lines of text content.

### Content Structure

This prompt file is organized into 7 sections:

- Line 72: # You must always use artifacts for
- Line 83: # Design principles for visual artifacts
- Line 103: # Usage notes
- Line 110: # CRITICAL BROWSER STORAGE RESTRICTION
- Line 166: # Reading Files
- Line 172: # Manipulating CSVs
- Line 180: # Updating vs rewriting artifacts
...
```python
with open('Anthropic/Sonnet 4.5 Prompt.txt', 'r') as f:
...
- [`Claude Code 2.0.txt`](./Claude Code 2.0.txt_docs.md)
