# Documentation: claude-4-sonnet-agent-prompts.txt

## File Metadata

- **Path**: `Augment Code/claude-4-sonnet-agent-prompts.txt`
- **Size**: 10836 bytes (10.58 KB)
- **MIME Type**: text/plain
- **Lines**: 160
- **Words**: 1697
- **Last Modified**: 2025-11-15T09:41:05.375333
...
This file contains 160 lines of text content.

### Content Structure

This prompt file is organized into 15 sections:

- Line 1: # Role
- Line 6: # Identity
- Line 11: # Preliminary tasks
- Line 20: # Planning and Task Management
- Line 51: # Making edits
- Line 64: # Package Management
- Line 83: # Following instructions
- Line 96: # Testing
- Line 103: # Displaying code
- Line 122: # Recovering from difficulties
- Line 125: # Final
- Line 140: # Memories
- Line 143: # Preferences
- Line 146: # Current Task List
- Line 149: # Summary of most important instructions
...
```python
with open('Augment Code/claude-4-sonnet-agent-prompts.txt', 'r') as f:
...
- [`claude-4-sonnet-tools.json`](./claude-4-sonnet-tools.json_docs.md)
- [`gpt-5-tools.json`](./gpt-5-tools.json_docs.md)
- [`gpt-5-agent-prompts.txt`](./gpt-5-agent-prompts.txt_docs.md)
