# Documentation: gpt-5-agent-prompts.txt

## File Metadata

- **Path**: `Augment Code/gpt-5-agent-prompts.txt`
- **Size**: 15035 bytes (14.68 KB)
...
This file contains 242 lines of text content.

### Content Structure

This prompt file is organized into 32 sections:

- Line 1: # Role
- Line 6: # Identity
- Line 11: # Output formatting
- Line 17: # Preliminary tasks
- Line 22: ## Tasklist Triggers (use tasklist tools if any apply)
- Line 22: ## Tasklist Triggers (use tasklist tools if any apply)
- Line 28: # Information-gathering tools
- Line 35: ## `view` tool
- Line 35: ## `view` tool
- Line 47: ## `grep-search` tool
- Line 47: ## `grep-search` tool
- Line 54: ## `codebase-retrieval` tool
- Line 54: ## `codebase-retrieval` tool
- Line 69: ## `git-commit-retrieval` tool
- Line 69: ## `git-commit-retrieval` tool
...
```python
with open('Augment Code/gpt-5-agent-prompts.txt', 'r') as f:
...
- [`claude-4-sonnet-agent-prompts.txt`](./claude-4-sonnet-agent-prompts.txt_docs.md)
