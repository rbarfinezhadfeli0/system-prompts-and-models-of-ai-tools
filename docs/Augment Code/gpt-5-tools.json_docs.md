# Documentation: gpt-5-tools.json

## File Metadata

- **Path**: `Augment Code/gpt-5-tools.json`
- **Size**: 19181 bytes (18.73 KB)
...
This file contains 550 lines of json content.
...
with open('Augment Code/gpt-5-tools.json', 'r') as f:
    data = json.load(f)
```
...
```bash
python -c "import json; json.load(open('Augment Code/gpt-5-tools.json'))"
# or
jq . 'Augment Code/gpt-5-tools.json'
```
