# Documentation: claude-code-system-prompt.txt

## File Metadata

- **Path**: `Claude Code/claude-code-system-prompt.txt`
- **Size**: 13019 bytes (12.71 KB)
- **MIME Type**: text/plain
- **Lines**: 192
- **Words**: 2071
- **Last Modified**: 2025-11-15T09:41:05.376333
...
This file contains 192 lines of text content.

### Content Structure

This prompt file is organized into 8 sections:

- Line 14: # Tone and style
- Line 65: # Proactiveness
- Line 71: # Following conventions
- Line 78: # Code style
- Line 82: # Task Management
- Line 132: # Doing tasks
- Line 145: # Tool usage policy
- Line 173: # Code References
...
```python
with open('Claude Code/claude-code-system-prompt.txt', 'r') as f:
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: secret, token
...
- [`claude-code-tools.json`](./claude-code-tools.json_docs.md)
