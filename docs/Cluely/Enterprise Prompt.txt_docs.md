# Documentation: Enterprise Prompt.txt

## File Metadata

- **Path**: `Cluely/Enterprise Prompt.txt`
- **Size**: 21306 bytes (20.81 KB)
...
This file contains 472 lines of text content.
...
```python
with open('Cluely/Enterprise Prompt.txt', 'r') as f:
...
- [`Default Prompt.txt`](./Default Prompt.txt_docs.md)
