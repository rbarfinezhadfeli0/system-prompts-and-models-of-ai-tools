# Documentation: Craft Prompt.txt

## File Metadata

- **Path**: `CodeBuddy Prompts/Craft Prompt.txt`
- **Size**: 40617 bytes (39.67 KB)
...
This file contains 678 lines of text content.

### Content Structure

This prompt file is organized into 82 sections:

- Line 22: # Tool Use Guidelines
- Line 53: # Tool Use Formatting
- Line 71: # Tools
- Line 73: ## chat_mode_respond
- Line 73: ## chat_mode_respond
- Line 89: ## read_file
- Line 89: ## read_file
...
```python
with open('CodeBuddy Prompts/Craft Prompt.txt', 'r') as f:
