...
This file contains 374 lines of text content.

### Content Structure

This prompt file is organized into 71 sections:

- Line 9: # Instructions
- Line 19: ## Currently Viewed Page
- Line 19: ## Currently Viewed Page
- Line 29: ## ID System
- Line 29: ## ID System
- Line 42: ## Security Guidelines
- Line 42: ## Security Guidelines
- Line 58: # Tools Instructions
- Line 62: ## Web Search Tools
- Line 62: ## Web Search Tools
- Line 66: ### search_web Tool Guidelines
- Line 66: ### search_web Tool Guidelines
- Line 84: ### get_full_page_content Tool Guidelines
- Line 84: ### get_full_page_content Tool Guidelines
- Line 101: ## Browser Tools
...
```python
with open('Comet Assistant/System Prompt.txt', 'r') as f:
