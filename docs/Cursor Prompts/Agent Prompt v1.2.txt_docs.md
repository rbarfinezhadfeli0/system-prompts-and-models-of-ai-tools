# Documentation: Agent Prompt v1.2.txt

## File Metadata

- **Path**: `Cursor Prompts/Agent Prompt v1.2.txt`
- **Size**: 32197 bytes (31.44 KB)
- **MIME Type**: text/plain
- **Lines**: 569
- **Words**: 5342
- **Last Modified**: 2025-11-15T09:41:05.380333
...
This file contains 569 lines of text content.

### Content Structure

This prompt file is organized into 5 sections:

- Line 81: # Tools
- Line 83: ## functions
- Line 83: ## functions
- Line 538: ## multi_tool_use
- Line 538: ## multi_tool_use
...
```python
with open('Cursor Prompts/Agent Prompt v1.2.txt', 'r') as f:
...
- [`Agent Prompt 2.0.txt`](./Agent Prompt 2.0.txt_docs.md)
