# Documentation: Agent Tools v1.0.json

## File Metadata

- **Path**: `Cursor Prompts/Agent Tools v1.0.json`
- **Size**: 23545 bytes (22.99 KB)
...
This file contains 327 lines of json content.

### JSON Structure

This JSON file contains an array with 13 elements.
...
```bash
python -c "import json; json.load(open('Cursor Prompts/Agent Tools v1.0.json'))"
# or
jq . 'Cursor Prompts/Agent Tools v1.0.json'
```
