...
- **Size**: 37424 bytes (36.55 KB)
- **MIME Type**: text/plain
- **Lines**: 947
- **Words**: 4689
- **Last Modified**: 2025-11-15T09:41:05.382333
...
This file contains 947 lines of text content.

### Content Structure

This prompt file is organized into 11 sections:

- Line 143: # IMPORTANT NOTES
- Line 145: # Context of Main Agent #
- Line 149: # Tips
- Line 154: # IMPORTANT NOTE ON WORKING WITH SUB AGENT
- Line 778: # MongoDB connection
- Line 783: # Create the main app without a prefix
- Line 786: # Create a router with the /api prefix
- Line 790: # Define Models
- Line 799: # Add your routes to the router instead of directly to app
- Line 816: # Include the router in the main app
- Line 827: # Configure logging
...
```python
with open('Emergent/Prompt.txt', 'r') as f:
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: token, credential
