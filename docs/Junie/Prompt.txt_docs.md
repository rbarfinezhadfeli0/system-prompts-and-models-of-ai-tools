...
This prompt file is organized into 54 sections:

- Line 1: ## ENVIRONMENT
- Line 1: ## ENVIRONMENT
- Line 13: ## SPECIAL COMMANDS
- Line 13: ## SPECIAL COMMANDS
- Line 14: ### search_project
- Line 14: ### search_project
- Line 17: #### Arguments
- Line 17: #### Arguments
- Line 20: #### Description
...
```python
with open('Junie/Prompt.txt', 'r') as f:
