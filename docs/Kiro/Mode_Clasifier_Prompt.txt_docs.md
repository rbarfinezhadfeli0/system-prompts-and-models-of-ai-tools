# Documentation: Mode_Clasifier_Prompt.txt

## File Metadata

- **Path**: `Kiro/Mode_Clasifier_Prompt.txt`
- **Size**: 2883 bytes (2.82 KB)
...
- Line 10: ### Category Definitions
- Line 10: ### Category Definitions
- Line 12: #### 1. Do mode (DEFAULT CHOICE)
- Line 12: #### 1. Do mode (DEFAULT CHOICE)
- Line 36: #### 2. Spec mode (ONLY for specification requests)
- Line 36: #### 2. Spec mode (ONLY for specification requests)
...
```python
with open('Kiro/Mode_Clasifier_Prompt.txt', 'r') as f:
