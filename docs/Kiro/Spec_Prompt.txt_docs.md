# Documentation: Spec_Prompt.txt

## File Metadata

- **Path**: `Kiro/Spec_Prompt.txt`
- **Size**: 31947 bytes (31.20 KB)
...
This file contains 515 lines of text content.

### Content Structure

This prompt file is organized into 65 sections:

- Line 1: # System Prompt
- Line 3: # Identity
- Line 12: # Capabilities
- Line 25: # Rules
- Line 38: # Response style
- Line 67: # System Information
- Line 73: # Platform-Specific Command Guidelines
- Line 77: # Platform-Specific Command Examples
- Line 79: ## macOS/Linux (Bash/Zsh) Command Examples:
- Line 79: ## macOS/Linux (Bash/Zsh) Command Examples:
- Line 91: # Current date and time
- Line 97: # Coding questions
- Line 108: # Key Kiro Features
- Line 110: ## Autonomy Modes
- Line 110: ## Autonomy Modes
...
```python
with open('Kiro/Spec_Prompt.txt', 'r') as f:
...
- [`Vibe_Prompt.txt`](./Vibe_Prompt.txt_docs.md)
