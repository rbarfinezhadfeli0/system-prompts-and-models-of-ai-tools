# Documentation: Vibe_Prompt.txt

## File Metadata

- **Path**: `Kiro/Vibe_Prompt.txt`
- **Size**: 14151 bytes (13.82 KB)
- **MIME Type**: text/plain
- **Lines**: 196
- **Words**: 2277
- **Last Modified**: 2025-11-15T09:41:05.384333
...
This file contains 196 lines of text content.

### Content Structure

This prompt file is organized into 26 sections:

- Line 1: # Identity
- Line 10: # Capabilities
- Line 23: # Rules
- Line 36: # Response style
- Line 65: # System Information
- Line 71: # Platform-Specific Command Guidelines
- Line 75: # Platform-Specific Command Examples
- Line 77: ## macOS/Linux (Bash/Zsh) Command Examples:
- Line 77: ## macOS/Linux (Bash/Zsh) Command Examples:
- Line 89: # Current date and time
- Line 95: # Coding questions
- Line 106: # Key Kiro Features
- Line 108: ## Autonomy Modes
- Line 108: ## Autonomy Modes
- Line 112: ## Chat Context
...
```python
with open('Kiro/Vibe_Prompt.txt', 'r') as f:
...
- [`Mode_Clasifier_Prompt.txt`](./Mode_Clasifier_Prompt.txt_docs.md)
- [`Spec_Prompt.txt`](./Spec_Prompt.txt_docs.md)
