# Documentation: Agent Prompt.txt

## File Metadata

- **Path**: `Lovable/Agent Prompt.txt`
- **Size**: 20301 bytes (19.83 KB)
...
This file contains 305 lines of text content.

### Content Structure

This prompt file is organized into 30 sections:

- Line 15: ## General Guidelines
- Line 15: ## General Guidelines
- Line 29: ### SEO Requirements:
- Line 29: ### SEO Requirements:
- Line 51: ## Required Workflow (Follow This Order)
- Line 51: ## Required Workflow (Follow This Order)
- Line 86: ## Efficient Tool Usage
- Line 86: ## Efficient Tool Usage
- Line 88: ### CARDINAL RULES:
- Line 88: ### CARDINAL RULES:
- Line 94: ### EFFICIENT FILE READING (BATCH WHEN POSSIBLE)
- Line 94: ### EFFICIENT FILE READING (BATCH WHEN POSSIBLE)
- Line 98: ### EFFICIENT CODE MODIFICATION
- Line 98: ### EFFICIENT CODE MODIFICATION
- Line 105: ## Coding guidelines
...
```python
with open('Lovable/Agent Prompt.txt', 'r') as f:
...
- [`Agent Tools.json`](./Agent Tools.json_docs.md)
