# Documentation: Agent Tools.json

## File Metadata

- **Path**: `Lovable/Agent Tools.json`
- **Size**: 27944 bytes (27.29 KB)
- **MIME Type**: application/json
- **Lines**: 437
- **Words**: 3460
- **Last Modified**: 2025-11-15T09:41:05.387333
...
This file contains 437 lines of json content.
...
with open('Lovable/Agent Tools.json', 'r') as f:
    data = json.load(f)
```
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: api_key, secret, token
...
- [`Agent Prompt.txt`](./Agent Prompt.txt_docs.md)
...
```bash
python -c "import json; json.load(open('Lovable/Agent Tools.json'))"
# or
jq . 'Lovable/Agent Tools.json'
```
