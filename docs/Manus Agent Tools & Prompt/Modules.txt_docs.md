...
This prompt file is organized into 3 sections:

- Line 86: # Use fully-qualified API names and parameters as specified in API documentation
- Line 87: # Always use complete query parameter format in query={...}, never omit paramete
- Line 90: # --snip--
...
```python
with open('Manus Agent Tools & Prompt/Modules.txt', 'r') as f:
