...
This file contains 251 lines of text content.

### Content Structure

This prompt file is organized into 89 sections:

- Line 1: # Manus AI Assistant Capabilities
- Line 3: ## Overview
- Line 3: ## Overview
- Line 6: ## General Capabilities
- Line 6: ## General Capabilities
- Line 8: ### Information Processing
- Line 8: ### Information Processing
- Line 15: ### Content Creation
- Line 15: ### Content Creation
- Line 22: ### Problem Solving
- Line 22: ### Problem Solving
- Line 29: ## Tools and Interfaces
- Line 29: ## Tools and Interfaces
- Line 31: ### Browser Capabilities
- Line 31: ### Browser Capabilities
...
```python
with open('Manus Agent Tools & Prompt/Prompt.txt', 'r') as f:
...
- [`Agent loop.txt`](./Agent loop.txt_docs.md)
