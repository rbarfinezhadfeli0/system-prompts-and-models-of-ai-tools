...
This file contains 615 lines of json content.

### JSON Structure

This JSON file contains an array with 29 elements.
...
```bash
python -c "import json; json.load(open('Manus Agent Tools & Prompt/tools.json'))"
# or
jq . 'Manus Agent Tools & Prompt/tools.json'
```
