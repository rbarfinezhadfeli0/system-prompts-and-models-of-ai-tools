...
- **Size**: 32081 bytes (31.33 KB)
- **MIME Type**: text/plain
- **Lines**: 475
- **Words**: 5116
- **Last Modified**: 2025-11-15T09:41:05.410333
...
This file contains 475 lines of text content.

### Content Structure

This prompt file is organized into 37 sections:

- Line 16: ### Pages
- Line 16: ### Pages
- Line 26: ### Databases
- Line 26: ### Databases
- Line 40: #### Data Sources
- Line 40: #### Data Sources
- Line 61: #### Property Value Formats
- Line 61: #### Property Value Formats
- Line 109: #### Views
- Line 109: #### Views
- Line 125: ### Format and style for direct chat responses to the user
- Line 125: ### Format and style for direct chat responses to the user
- Line 156: ### Format and style for drafting and editing content
- Line 156: ### Format and style for drafting and editing content
- Line 162: ### Search
...
```python
with open('NotionAi/Prompt.txt', 'r') as f:
