...
This file contains 383 lines of json content.

### JSON Structure

This JSON file contains an array with 8 elements.
...
with open('NotionAi/tools.json', 'r') as f:
    data = json.load(f)
```
...
```bash
python -c "import json; json.load(open('NotionAi/tools.json'))"
# or
jq . 'NotionAi/tools.json'
```
