...
- **Size**: 47083 bytes (45.98 KB)
- **MIME Type**: text/plain
- **Lines**: 608
- **Words**: 7213
- **Last Modified**: 2025-11-15T09:41:05.412333
...
This file contains 608 lines of text content.

### Content Structure

This prompt file is organized into 66 sections:

- Line 9: # Tool Use Formatting
- Line 27: # Tools
- Line 29: ## execute_command
- Line 29: ## execute_command
- Line 40: ## read_file
- Line 40: ## read_file
- Line 49: ## write_to_file
- Line 49: ## write_to_file
- Line 62: ## replace_in_file
- Line 62: ## replace_in_file
- Line 98: ## search_files
- Line 98: ## search_files
- Line 111: ## list_files
- Line 111: ## list_files
- Line 122: ## list_code_definition_names
...
```python
with open('Open Source prompts/Cline/Prompt.txt', 'r') as f:
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: password, token
