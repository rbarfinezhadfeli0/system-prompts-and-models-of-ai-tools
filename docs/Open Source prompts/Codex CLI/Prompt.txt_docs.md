...
```python
with open('Open Source prompts/Codex CLI/Prompt.txt', 'r') as f:
...
- [`openai-codex-cli-system-prompt-20250820.txt`](./openai-codex-cli-system-prompt-20250820.txt_docs.md)
