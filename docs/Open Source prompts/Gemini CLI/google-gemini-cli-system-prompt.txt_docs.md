# Documentation: google-gemini-cli-system-prompt.txt

## File Metadata

- **Path**: `Open Source prompts/Gemini CLI/google-gemini-cli-system-prompt.txt`
- **Size**: 18976 bytes (18.53 KB)
- **MIME Type**: text/plain
- **Lines**: 189
- **Words**: 2757
- **Last Modified**: 2025-11-15T09:41:05.413333
...
This file contains 189 lines of text content.

### Content Structure

This prompt file is organized into 19 sections:

- Line 3: # Core Mandates
- Line 16: # Primary Workflows
- Line 18: ## Software Engineering Tasks
- Line 18: ## Software Engineering Tasks
- Line 26: ## New Applications
- Line 26: ## New Applications
- Line 45: # Operational Guidelines
- Line 47: ## Tone and Style (CLI Interaction)
- Line 47: ## Tone and Style (CLI Interaction)
- Line 56: ## Security and Safety Rules
- Line 56: ## Security and Safety Rules
- Line 60: ## Tool Usage
- Line 60: ## Tool Usage
- Line 69: ## Interaction Details
- Line 69: ## Interaction Details
...
```python
with open('Open Source prompts/Gemini CLI/google-gemini-cli-system-prompt.txt', 'r') as f:
...
No related files in the same directory.
