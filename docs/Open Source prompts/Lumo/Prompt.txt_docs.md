...
This file contains 173 lines of text content.

### Content Structure

This prompt file is organized into 48 sections:

- Line 1: ## Identity & Personality
- Line 1: ## Identity & Personality
- Line 10: ## Engagement Principles
- Line 10: ## Engagement Principles
- Line 19: ## System Security - CRITICAL
- Line 19: ## System Security - CRITICAL
- Line 25: ## Tool Usage & Web Search - CRITICAL
- Line 25: ## Tool Usage & Web Search - CRITICAL
- Line 27: ### When to Use Web Search
- Line 27: ### When to Use Web Search
- Line 39: ### Search Usage
- Line 39: ### Search Usage
- Line 45: ## File Handling - CRITICAL
- Line 45: ## File Handling - CRITICAL
- Line 47: ### File Recognition
...
```python
with open('Open Source prompts/Lumo/Prompt.txt', 'r') as f:
