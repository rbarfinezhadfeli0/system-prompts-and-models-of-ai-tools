...
- **Size**: 43961 bytes (42.93 KB)
- **MIME Type**: text/plain
- **Lines**: 666
- **Words**: 6493
- **Last Modified**: 2025-11-15T09:41:05.414333
...
This file contains 666 lines of text content.

### Content Structure

This prompt file is organized into 37 sections:

- Line 52: # Tool Use Formatting
- Line 70: # Tools
- Line 72: ## read_file
- Line 72: ## read_file
- Line 114: ## fetch_instructions
- Line 114: ## fetch_instructions
- Line 127: ## search_files
- Line 127: ## search_files
- Line 147: ## list_files
- Line 147: ## list_files
- Line 164: ## list_code_definition_names
- Line 164: ## list_code_definition_names
- Line 185: ## apply_diff
- Line 185: ## apply_diff
- Line 279: ## write_to_file
...
```python
with open('Open Source prompts/RooCode/Prompt.txt', 'r') as f:
