# Documentation: Decision-making prompt.txt

## File Metadata

- **Path**: `Orchids.app/Decision-making prompt.txt`
- **Size**: 6820 bytes (6.66 KB)
...
This file contains 104 lines of text content.
...
```python
with open('Orchids.app/Decision-making prompt.txt', 'r') as f:
...
- [`System Prompt.txt`](./System Prompt.txt_docs.md)
