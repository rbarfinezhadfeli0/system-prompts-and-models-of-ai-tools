# Documentation: System Prompt.txt

## File Metadata

- **Path**: `Orchids.app/System Prompt.txt`
- **Size**: 58779 bytes (57.40 KB)
- **MIME Type**: text/plain
- **Lines**: 1015
- **Words**: 8373
- **Last Modified**: 2025-11-15T09:41:05.415333
...
This file contains 1015 lines of text content.

### Content Structure

This prompt file is organized into 1 sections:

- Line 291: # Forbidden inside client components (will break in the browser)
...
```python
with open('Orchids.app/System Prompt.txt', 'r') as f:
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: password, secret, token, credential
...
- [`Decision-making prompt.txt`](./Decision-making prompt.txt_docs.md)
