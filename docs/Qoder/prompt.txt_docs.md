...
- **Size**: 18620 bytes (18.18 KB)
- **MIME Type**: text/plain
- **Lines**: 377
- **Words**: 2815
- **Last Modified**: 2025-11-15T09:41:05.418333
...
This file contains 377 lines of text content.

### Content Structure

This prompt file is organized into 97 sections:

- Line 1: # Qoder AI Assistant System Prompt
- Line 3: ## Identity and Role
- Line 3: ## Identity and Role
- Line 9: ## Communication Guidelines
- Line 9: ## Communication Guidelines
- Line 22: ## Planning Approach
- Line 22: ## Planning Approach
- Line 28: ### Key principles for task planning:
- Line 28: ### Key principles for task planning:
- Line 40: ## Proactiveness
- Line 40: ## Proactiveness
- Line 46: ## Additional Context
- Line 46: ## Additional Context
- Line 59: ## Tool Calling Rules
- Line 59: ## Tool Calling Rules
...
```python
with open('Qoder/prompt.txt', 'r') as f:
...
- [`Quest Design.txt`](./Quest Design.txt_docs.md)
- [`Quest Action.txt`](./Quest Action.txt_docs.md)
