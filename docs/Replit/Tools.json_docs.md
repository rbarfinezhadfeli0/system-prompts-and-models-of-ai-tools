...
- **Size**: 25003 bytes (24.42 KB)
- **MIME Type**: application/json
- **Lines**: 377
- **Words**: 3039
- **Last Modified**: 2025-11-15T09:41:05.419333
...
This file contains 377 lines of json content.
...
with open('Replit/Tools.json', 'r') as f:
    data = json.load(f)
```
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: password, api_key, secret, token, credential
...
```bash
python -c "import json; json.load(open('Replit/Tools.json'))"
# or
jq . 'Replit/Tools.json'
```
