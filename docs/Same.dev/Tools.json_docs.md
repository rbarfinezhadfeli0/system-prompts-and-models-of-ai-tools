...
This file contains 402 lines of json content.

### JSON Structure

This JSON file contains an array with 16 elements.
...
with open('Same.dev/Tools.json', 'r') as f:
    data = json.load(f)
```
...
```bash
python -c "import json; json.load(open('Same.dev/Tools.json'))"
# or
jq . 'Same.dev/Tools.json'
```
