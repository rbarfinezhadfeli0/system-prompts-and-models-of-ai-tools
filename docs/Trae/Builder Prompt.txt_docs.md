# Documentation: Builder Prompt.txt

## File Metadata

- **Path**: `Trae/Builder Prompt.txt`
- **Size**: 18569 bytes (18.13 KB)
...
This file contains 267 lines of text content.

### Content Structure

This prompt file is organized into 4 sections:

- Line 185: ## Examples of When NOT to Use the Todo List
- Line 185: ## Examples of When NOT to Use the Todo List
- Line 237: ## Task States and Management
- Line 237: ## Task States and Management
...
```python
with open('Trae/Builder Prompt.txt', 'r') as f:
...
- [`Builder Tools.json`](./Builder Tools.json_docs.md)
