# Documentation: phase_mode_tools.json

## File Metadata

- **Path**: `Traycer AI/phase_mode_tools.json`
- **Size**: 18618 bytes (18.18 KB)
...
This file contains 337 lines of json content.
...
with open('Traycer AI/phase_mode_tools.json', 'r') as f:
    data = json.load(f)
```
...
```bash
python -c "import json; json.load(open('Traycer AI/phase_mode_tools.json'))"
# or
jq . 'Traycer AI/phase_mode_tools.json'
```
