# Documentation: plan_mode_prompts

## File Metadata

- **Path**: `Traycer AI/plan_mode_prompts`
- **Size**: 6143 bytes (6.00 KB)
...
### Purpose
AI system prompt or instructions
...
This file contains 93 lines of text content.

### Content Structure

This prompt file is organized into 1 sections:

- Line 79: NOTE: You must use one of the provided tools to generate your response. TEXT onl
...
```python
with open('Traycer AI/plan_mode_prompts', 'r') as f:
