# Documentation: plan_mode_tools.json

## File Metadata

- **Path**: `Traycer AI/plan_mode_tools.json`
- **Size**: 16752 bytes (16.36 KB)
...
This file contains 346 lines of json content.

### JSON Structure

This JSON file contains a dictionary with 15 top-level keys:
...
- `think`: dict
- `read_file`: dict
- `read_partial_file`: dict
- `file_outlines`: dict
- `find_references`: dict
- `go_to_definition`: dict
- `go_to_implementations`: dict
- `get_diagnostics`: dict
- `agent`: dict
- `hand_over_to_approach_agent`: dict
- `explanation_response`: dict
...
with open('Traycer AI/plan_mode_tools.json', 'r') as f:
    data = json.load(f)
```
...
- [`phase_mode_prompts.txt`](./phase_mode_prompts.txt_docs.md)
...
```bash
python -c "import json; json.load(open('Traycer AI/plan_mode_tools.json'))"
# or
jq . 'Traycer AI/plan_mode_tools.json'
```
