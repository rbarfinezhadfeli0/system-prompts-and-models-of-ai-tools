...
- **Size**: 14595 bytes (14.25 KB)
- **MIME Type**: text/plain
- **Lines**: 163
- **Words**: 2405
- **Last Modified**: 2025-11-15T09:41:05.424333
...
This file contains 163 lines of text content.

### Content Structure

This prompt file is organized into 23 sections:

- Line 8: # Question
- Line 13: # Task
- Line 16: ## Simple tasks
- Line 16: ## Simple tasks
- Line 20: ## Complex tasks
- Line 20: ## Complex tasks
- Line 24: # External context
- Line 40: # Tools
- Line 78: # Running terminal commands
- Line 90: # Coding
- Line 100: # Output formatting rules
- Line 108: ## File Paths
- Line 108: ## File Paths
- Line 112: ### Rules
- Line 112: ### Rules
...
```python
with open('Warp.dev/Prompt.txt', 'r') as f:
...
⚠️ **WARNING**: This file may contain sensitive information. Found keywords: api_key, secret
