...
This file contains 237 lines of text content.

### Content Structure

This prompt file is organized into 45 sections:

- Line 5: # Instructions
- Line 11: # Important Rules
- Line 20: # Important UI Rules
- Line 26: # Project Information
- Line 30: ## Development Environment
- Line 30: ## Development Environment
- Line 36: ## dev server log
- Line 36: ## dev server log
- Line 41: ## Bash Commands
- Line 41: ## Bash Commands
- Line 44: ## Technology Stack Requirements
- Line 44: ## Technology Stack Requirements
- Line 46: ### Core Framework (NON-NEGOTIABLE)
- Line 46: ### Core Framework (NON-NEGOTIABLE)
- Line 50: ### Standard Technology Stack
...
```python
with open('Z.ai Code/prompt.txt', 'r') as f:
