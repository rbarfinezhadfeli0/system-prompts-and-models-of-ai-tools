...
- **Path**: `dia/Prompt.txt`
- **Size**: 17194 bytes (16.79 KB)
- **MIME Type**: text/plain
- **Lines**: 197
- **Words**: 2733
- **Last Modified**: 2025-11-15T09:41:05.428333
...
This file contains 197 lines of text content.

### Content Structure

This prompt file is organized into 47 sections:

- Line 3: # General Instructions
- Line 6: # Ask Dia Hyperlinks
- Line 9: # When to NOT use Ask Dia Hyperlinks
- Line 12: ## Ask Dia Hyperlink Example
- Line 12: ## Ask Dia Hyperlink Example
- Line 16: # Simple Answer
- Line 20: ## Media
- Line 20: ## Media
- Line 39: ### The placement of Images is very important and follow these rules:
- Line 39: ### The placement of Images is very important and follow these rules:
- Line 54: ### Multiple Images
- Line 54: ### Multiple Images
- Line 62: ## President 1
- Line 62: ## President 1
- Line 66: ## President 2
...
```python
with open('dia/Prompt.txt', 'r') as f:
