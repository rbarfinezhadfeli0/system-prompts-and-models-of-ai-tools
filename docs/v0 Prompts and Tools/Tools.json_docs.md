...
- **Size**: 28966 bytes (28.29 KB)
- **MIME Type**: application/json
- **Lines**: 327
- **Words**: 3242
- **Last Modified**: 2025-11-15T09:41:05.430333
...
with open('v0 Prompts and Tools/Tools.json', 'r') as f:
    data = json.load(f)
```
...
```bash
python -c "import json; json.load(open('v0 Prompts and Tools/Tools.json'))"
# or
jq . 'v0 Prompts and Tools/Tools.json'
```
